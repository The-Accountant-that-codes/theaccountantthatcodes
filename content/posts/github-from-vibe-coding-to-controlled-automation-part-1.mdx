...
Git is the version control system that runs locally and tracks changes to your files over time. GitHub is the cloud platform that hosts Git repositories and adds collaboration, permissions, secrets management, and review workflows on top.

**Q: Do finance teams really need GitHub?**
Once a script touches financial reporting, it becomes part of your control environment — and GitHub is the cheapest way to get version history, change approval, and secrets management that auditors will accept. A script on someone's laptop is a control deficiency waiting to be written up.

**Q: Is GitHub free?**
Yes for what finance teams need to start: free accounts include unlimited private repositories and a monthly allowance of GitHub Actions minutes. You only pay when you need advanced org-level controls or heavy automation volume.
